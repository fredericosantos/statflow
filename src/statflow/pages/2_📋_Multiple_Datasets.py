...
from statflow.pages_modules.module_2_Multiple_Datasets.processor import (
...
def main():
    ...
    with st.sidebar:
        ...
        from streamlit_comparison.components.filters import render_dataset_names_expander
    ...
    with tab_names:
        ...
        from streamlit_comparison.config import DEFAULT_DATASET_RENAMES
