...
results_page = st.Page("subpages/results.py", title="Results", icon=":material/table_chart:")
comparison_page = st.Page("subpages/comparison.py", title="Comparison", icon=":material/compare:")
